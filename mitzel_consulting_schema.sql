-- =====================================================
-- MITZEL CONSULTING DATABASE SCHEMA
...
Ready to begin your OSHA 30-Hour Construction Safety training? Contact Mitzel Consulting today to learn about our comprehensive training programs, available in both digital and on-site formats.', 'Kris Mitzel', NOW(), 'published', (SELECT id FROM blog_categories WHERE slug = 'osha-training'), ARRAY['OSHA', 'Construction Safety', 'Training', 'Certification'], 'OSHA 30-Hour Construction Safety Training Guide | Mitzel Consulting', 'Complete guide to OSHA 30-Hour Construction Safety certification. Learn requirements, benefits, and how to get started with professional safety training.'),
...
Working with experienced safety training providers like Mitzel Consulting can help you implement these strategies effectively. We offer comprehensive safety training programs, consultation services, and ongoing support to help you maintain a safe workplace.

Ready to enhance your workplace safety program? Contact us today to learn how we can help protect your employees and ensure regulatory compliance.', 'Kris Mitzel', NOW(), 'published', (SELECT id FROM blog_categories WHERE slug = 'workplace-safety'), ARRAY['HR', 'Workplace Safety', 'Safety Management', 'OSHA Compliance'], 'Workplace Safety Tips for HR Directors | Mitzel Consulting', 'Essential workplace safety tips for HR Directors. Learn how to create a safer work environment and protect your employees with expert guidance.');
...
('kris@mitzelconsulting.com', 'Kris', 'Mitzel', 'super_admin', true, true);
